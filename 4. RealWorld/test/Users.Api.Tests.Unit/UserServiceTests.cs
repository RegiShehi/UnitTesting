...
public class UserServiceTests
{
    ...
    public async Task GetAllAsync_ShouldReturnUsers_WhenSomeUsersExist()
    {
        ...
        enumerable.Should().BeEquivalentTo(expectedUsers);
    ...
    public async Task GetAllAsync_ShouldLogMessageAndException_WhenExceptionIsThrown()
    {
        ...
        _logger.Received(1)
            .LogError(Arg.Is(sqlLiteException), Arg.Is("Something went wrong while retrieving all users"));
    }

    [Fact]
    public async Task GetAllIdAsync_ShouldReturnNull_WhenNoUserIsFound()
    {
